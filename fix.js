/**
 * AXON CORE - Modular Page Builder Phase 5: Global Theme Builder & Responsive Live Studio (fix.js)
 */
...
console.log("\x1b[36m[AXON-BUILDER-PHASE5]\x1b[0m پیاده‌سازی Theme Builder سراسری، تنظیمات تم و ادیتور رسپانسیو...");

// =============================================================================
// ۱. روت اختصاصی سرور برای تم سراسری: app/api/theme-builder/route.ts
// =============================================================================
const themeBuilderRoute = `import { NextRequest, NextResponse } from "next/server";
...
`;
writeFile('app/api/theme-builder/route.ts', themeBuilderRoute);

// =============================================================================
// ۲. ارتقای components/admin/AdminModularPages.tsx با قابلیت Theme Builder و شبیه‌ساز ریسپانسیو
// =============================================================================
const visualEditorWithThemeBuilder = `"use client";
...
`;
writeFile('components/admin/AdminModularPages.tsx', visualEditorWithThemeBuilder);

// =============================================================================
// ۳. تست بیلد کامل و پوش قطعی به گیت‌هاب و ورسل
// =============================================================================
console.log("تست بیلد کامل فاز ۵ (npm run build)...");
try {
...
console.log("ارسال قطعی تغییرات فاز ۵ به گیت‌هاب و تریگر دیپلوی ورسل...");
try {
  execSync('git config --global http.sslBackend openssl', { stdio: 'inherit' });
  execSync('git add -A', { stdio: 'inherit' });
  execSync('git commit -m "feat(modular-builder): phase 5 complete - site-wide theme builder, drag-and-drop layer reordering & responsive live studio"', { stdio: 'inherit' });
  ...
  console.log("\x1b[32m✔ کلیه ۵ فاز صفحه ساز ماژولار و Theme Builder با موفقیت استقرار یافتند!\x1b[0m");
} catch (e) {
