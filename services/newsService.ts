    ...
    return [
      {
        ...
        <p>این گجت‌ها با هماهنگی کامل سیستم‌عامل‌های اختصاصی، توانایی تشخیص خودکار نور محیط، گاموت رنگی sRGB و DCI-P3 و تنظیم فرکانس تازه سازی از ۱ تا ۲۴۰ هرتز را دارا می‌باشند.</p>`,
        category: "hardware",
      ...
      },
      {
        ...
        <p>تکنولوژی جدید ضد انعکاس نوری و هیت‌سینک گرافنی اختصاصی، طول عمر پنل‌های OLED را تا دو برابر افزایش داده و از هرگونه افت فریم یا هاله سوختگی جلوگیری می‌کند.</p>`,
        category: "gaming",
