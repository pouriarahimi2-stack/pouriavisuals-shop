...
console.log('🚀 در حال ساخت موتور کالبدشکافی سه‌بعدی سینمایی و فیزیکی دقیقاً مشابه ویدیوی اپل...');
...
try {
  execSync('git add . && git commit -m "feat: Apple keynote style physical 3d teardown with OLED, LiDAR, M-series logicboard and unibody chassis" && git push origin main', { stdio: 'inherit' });
  console.log('🎉 کالبدشکافی سینمایی و فیزیکی اپلی با موفقیت روی سرور آنلاین منتشر شد!');
} catch (e) {
