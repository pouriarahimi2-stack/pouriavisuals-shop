      ...
      <div className="relative w-full h-56 rounded-2xl overflow-hidden bg-[var(--input-bg)] mb-4 flex items-center justify-center p-3 border border-[var(--card-border)]">
        ...
        {!isAvailable && (
          <div className="absolute inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center">
            <span className="px-4 py-1.5 rounded-full bg-rose-600 text-white text-xs font-black">
              ناموجود در انبار
            </span>
          </div>
        )}
      ...
      <div className="pt-3 border-t border-[var(--card-border)] space-y-3 mt-auto">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="py-2.5 bg-[var(--input-bg)] text-[var(--text-primary)] text-xs font-black rounded-xl border border-[var(--card-border)] hover:border-[var(--accent-blue)] cursor-pointer disabled:opacity-40 transition"
          >
            🛒 سبد خرید
          </button>
          <button
