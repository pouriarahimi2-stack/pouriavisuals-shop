/**
 * AXON CORE - Fix Color Picker Visibility & Labels in Puck Sidebar (fix.js)
 */
...
console.log("\x1b[36m[AXON-FIX]\x1b[0m اصلاح نمایش عنوان و متن فیلدهای انتخاب رنگ در سایدبار...");
...
try {
  ...
  execSync(
    'git commit -m "fix(puck-ui): add explicit labels and contrast styling for custom color pickers in sidebar"',
    { stdio: "inherit" }
  );
  ...
  console.log("\x1b[32m✔ اصلاح نمایش فیلدهای رنگ با موفقیت منتشر شد!\x1b[0m");
} catch (e) {
