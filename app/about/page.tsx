...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-[70vh] max-w-4xl mx-auto px-4 py-12 font-sans select-none text-[var(--text-primary)] pb-36 sm:pb-12" dir="rtl">
      <div className="p-8 md:p-12 rounded-[2.5rem] bg-[var(--modal-bg)] border border-[var(--card-border)] space-y-6 shadow-2xl backdrop-blur-2xl">
        <div className="flex items-center gap-3 border-b border-[var(--card-border)] pb-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary)] mt-1 font-bold">معرفی، تعهدات و استانداردهای اصالت کالا</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-[var(--card-border)]">
          <div className="p-4 rounded-2xl bg-[var(--input-bg)] border border-[var(--card-border)] space-y-1 text-center">
            ...
            <strong className="text-xs font-black text-[var(--text-primary)] block">ضمانت اصالت فیزیکی</strong>
            <p className="text-[11px] text-[var(--text-secondary)]">تضمین ۱۰۰٪ سلامت و اورجینال بودن</p>
          </div>

          <div className="p-4 rounded-2xl bg-[var(--input-bg)] border border-[var(--card-border)] space-y-1 text-center">
            <span className="text-2xl block">🚀</span>
            <strong className="text-xs font-black text-[var(--text-primary)] block">ارسال سریع پیشتاز</strong>
            <p className="text-[11px] text-[var(--text-secondary)]">بسته‌بندی ایمن و ضدضربه پستی</p>
          </div>

          <div className="p-4 rounded-2xl bg-[var(--input-bg)] border border-[var(--card-border)] space-y-1 text-center">
            <span className="text-2xl block">💬</span>
            <strong className="text-xs font-black text-[var(--text-primary)] block">مشاوره تخصصی خرید</strong>
            <p className="text-[11px] text-[var(--text-secondary)]">راهنمایی آنلاین انتخاب بهترین گجت</p>
          </div>
        </div>
