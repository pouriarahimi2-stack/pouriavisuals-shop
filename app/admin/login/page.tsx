      ...
      <div className="relative w-full max-w-md p-8 sm:p-10 rounded-[2.5rem] bg-slate-900/95 border border-slate-800 backdrop-blur-2xl shadow-2xl space-y-6">
        {isVerified ? (
          ...
          <>
            ...
            {errorMessage && (
              <div className="p-3.5 rounded-2xl bg-rose-500/15 border border-rose-500/30 text-rose-400 text-xs font-bold text-center">
                ⚠️ {errorMessage}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-slate-300 block">کلمه عبور یا پین‌کد:</label>
