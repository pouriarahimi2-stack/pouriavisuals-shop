/**
 * AXON CORE - In-Place Category Edit & Delete inside Product Form (fix.js)
 */
...
console.log("\x1b[36m[AXON-FIX]\x1b[0m افزودن قابلیت ویرایش و حذف مستقیم دسته در فرم محصول...");

// =============================================================================
// ۱. ارتقای روت سروری app/api/categories/route.ts (پشتیبانی از PUT و DELETE)
// =============================================================================
...
// =============================================================================
// ۲. به‌روزرسانی services/categoryService.ts برای اتصال به متدهای سرور
// =============================================================================
...
// =============================================================================
// ۳. اصلاح components/AdminProducts.tsx: افزودن دکمه‌های ویرایش و حذف دسته در فرم
// =============================================================================
...
try {
  ...
  execSync('git commit -m "feat(categories): in-place edit and delete controls right inside the product form"', { stdio: 'inherit' });
  ...
  console.log("\x1b[32m✔ قابلیت ویرایش و حذف در فرم کالا روی سرور لایو مستقر گردید!\x1b[0m");
} catch (e) {
