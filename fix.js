/**
 * AXON CORE - Elementor Pro True Visual Studio Engine (fix.js)
 */
...
console.log("\x1b[36m[AXON-ELEMENTOR-PRO]\x1b[0m پیاده‌سازی موتور ویرایش مستقیم در بوم، باکس‌مدل فاصله‌گذاری، تایپوگرافی و CSS زنده...");

// =============================================================================
// بازنویسی components/admin/AdminModularPages.tsx به موتور تمام‌عیار Elementor Pro
// =============================================================================
const fullElementorProStudio = `"use client";
...
`;
writeFile('components/admin/AdminModularPages.tsx', fullElementorProStudio);

// =============================================================================
// بیلد کامل و پوش قطعی به گیت‌هاب و ورسل
// =============================================================================
...
try {
  ...
  execSync('git commit -m "feat(elementor-pro): true inline on-canvas editing, box-model spacing controller, live typography & custom css injector"', { stdio: 'inherit' });
  ...
  console.log("\x1b[32m✔ استودیوی المنتور پرو با موفقیت دیپلوی گردید!\x1b[0m");
} catch (e) {
